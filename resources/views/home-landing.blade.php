...
<div class="row" >
    ...
    @if($apps)
      @foreach($apps as $list)
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" style="margin-bottom: 10px">
            <a class="card card-banner card-green-light" href="{{ url($list->name.'/overview') }}">
              <div class="card-body">
              	@if($list->tipe =='android')
	                <i class="icon fa fa-android fa-4x"></i>
	            @elseif($list->tipe =='web')
	                <i class="icon fa fa-web fa-4x"></i>
	            @elseif($list->tipe =='ios')
	                <i class="icon fa fa-ios fa-4x"></i>
	            @else
	                <i class="icon fa fa-ban fa-4x"></i>
	            @endif 
                <div class="content">
                  <div class="title"> {{$list->description}} </div>
                  <div class="value"><span class="sign"></span>{{$list->name}}  </div>
                </div>
              </div>
            </a>
        </div>
  ...
  <div class="card"  id="tambah" style="display: none">
    <div class="card-header">
            ...
            <div class="form-footer">
              <div class="form-group">
                <div class="col-md-9 col-md-offset-3">
                  ...
                  <button type="button" class="btn btn-default" id="setting-cancel">Cancel</button>
                </div>
              </div>
            </div>
          </form>
